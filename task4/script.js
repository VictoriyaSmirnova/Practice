...
/*var articleFullRenderer = (function () {
    ...
    function init() {
        ...
        articleListNode = document.querySelector('.article_list');
    }
    ...
    function renderArticle(article) {
        ...
        if (document.getElementById('user-name').firstElementChild.innerHTML === "Войти") {
            template.content.querySelector('#edit1').style.display = 'none';
            template.content.querySelector('#delete1').style.display = 'none';
        } else {
            template.content.querySelector('#edit1').style.display = 'inline-block';
            template.content.querySelector('#delete1').style.display = 'inline-block';
        }
        template.content.querySelector('.article_full').dataset.id = article.id;
        template.content.querySelector('.news-title1').textContent = article.title;
        template.content.querySelector('.news-text').textContent = article.content;
        template.content.querySelector('.news-author1').textContent = article.author;
        template.content.querySelector('.news-date1').textContent = formatDate(article.createdAt);
        template.content.querySelector('.news-tags1').textContent = article.tags;
